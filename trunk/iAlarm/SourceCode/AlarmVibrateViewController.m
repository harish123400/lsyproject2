...
@implementation AlarmVibrateViewController
...
- (void)viewDidLoad {
	...
	self.title = NSLocalizedString(@"震动",@"指示闹钟是否震动的标签");
	//修改视图背景等
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (cell == nil) {
		...
		self.vibrateSwitch = [[[UISwitch alloc] initWithFrame:nameLabelRect] autorelease];
		self.vibrateSwitch.backgroundColor = [UIColor clearColor];
		
		[cell.contentView addSubview: self.vibrateSwitch];

	}
	
	// Configure the cell...
	cell.textLabel.text = NSLocalizedString(@"震动",@"指示闹钟是否震动的标签");
	vibrateSwitch.on = self.alarm.vibrate;
